...
pluck(data_final,8,19) # subjects 3,4, 7,10, 16, 18 and 19 responded slower in one or more training conditions, on 1 or more days compared to others (median RT > 1500)
```
...
data_test <- data_clean %>% mutate(range = ifelse(RT < 600 | RT > 1500, 0,1))
head(data_test)
summary(data_test)
